...
"[project]/node_modules/@portabletext/html/dist/_chunks-es/helpers.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@portabletext/html/dist/index.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@portabletext/html/dist/_chunks-es/helpers.js [app-ssr] (ecmascript)");
;
;
;
...
function isWordOnlineTextRun(el) {
    return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) !== "span" ? !1 : el.classList.contains("TextRun") && !el.classList.contains("EOP");
}
...
function isInHeading(el) {
    let current = el;
    for(; current;){
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(current) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(current) === "word-online-block" && /^heading \d$/.test(current.getAttribute("data-parastyle") ?? "")) return !0;
...
function preprocessWordOnline(html, doc) {
    ...
    for(; child;){
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(child) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(child)?.includes("span")) {
            child = next;
            continue;
        }
        ...
        let sibling = next;
        for(; sibling && !(!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(sibling) || getParaStyle(sibling) !== paraStyle);)group.push(sibling), sibling = sibling.nextSibling;
        const wrapper = doc.createElement("word-online-block");
    ...
    for (const textRunSpan of textRunSpans){
        ...
        for (const normalTextRun of normalTextRuns){
            ...
            for(; foundNestedSpan;){
                const children = Array.from(normalTextRun.childNodes), nestedSpanIndex = children.findIndex((node)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(node) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(node) === "span" && node.textContent.trim() === "");
                ...
                if (normalTextRun.removeChild(nestedSpan), isSpaceAtBeginning) {
                    ...
                    if (nextSibling && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(nextSibling) && isTextRunSpan(nextSibling)) {
                        ...
                        if (currentHasFormatting && !nextHasFormatting) {
                            ...
                            if (nextNormalTextRun && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(nextNormalTextRun)) {
...
function getParaStyle(element) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(element) === "span" && element.classList.contains("TextRun")) {
...
function preprocessGDocs(_html, doc) {
    ...
    if (gDocsRootOrSiblingNode) {
        const isWrappedRootTag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(gDocsRootOrSiblingNode) === "b";
        ...
        for(let i = childNodes.snapshotLength - 1; i >= 0; i--){
            ...
            elm?.setAttribute("data-is-google-docs", "true"), (elm?.parentElement === gDocsRootOrSiblingNode || !isWrappedRootTag && elm.parentElement === doc.body) && (elm?.setAttribute("data-is-root-node", "true"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(elm)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(elm) === "li" && elm.firstChild && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(elm?.firstChild) === "img" && elm.removeChild(elm.firstChild);
        }
...
function preprocessWhitespace(_, doc) {
    function processNode(node) {
        if (node.nodeType === _XPathResult.BOOLEAN_TYPE && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PRESERVE_WHITESPACE_TAGS"].includes(node.parentElement?.tagName.toLowerCase() || "")) {
...
function createWordOnlineRules(schema, options) {
    return [
        ...
        {
            deserialize (el) {
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el)) return;
                const classNameRaw = el.className;
                let className = "";
        ...
        // List item rule - handles <li> elements with aria-level
        {
            deserialize (el, next) {
                ...
                if (!ariaLevel) return;
                const listItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el.parentNode) === "ol" ? "number" : "bullet";
                let childNodesToProcess = el.childNodes, blockStyle = "normal";
                if (el.childNodes.length === 1 && el.firstChild && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el.firstChild)) {
                    const childTag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el.firstChild);
                    if (childTag && (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_BLOCK_TAGS"][childTag] || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_HEADER_TAGS"][childTag] || childTag === "word-online-block")) {
        ...
        // TextRun rule
        {
            deserialize (el) {
                if (isWordOnlineTextRun(el)) {
                    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) || !el.textContent) return;
                    const text = Array.from(el.childNodes).filter((node)=>isNormalTextRun(node) || isFindHit(node)).map((span2)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(span2) ? span2.textContent ?? "" : "").join("");
                    if (!text) return;
                    const span = {
                        ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_SPAN"],
                        marks: [],
                        text
                    };
                    if (hasStrongFormatting(el) && span.marks.push("strong"), hasEmphasisFormatting(el) && !isInHeading(el) && !isInBlockquote(el) && span.marks.push("em"), hasUnderlineFormatting(el)) if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) && el.parentElement && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el.parentElement) === "a") {
                        const linkElement = el.parentElement;
                        if (linkElement) {
                            const prevSibling = linkElement.previousSibling, nextSibling = linkElement.nextSibling, hasPrevUnderline = prevSibling && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(prevSibling) && hasUnderlineFormatting(prevSibling), hasNextUnderline = nextSibling && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(nextSibling) && hasUnderlineFormatting(nextSibling);
...
const LIST_CONTAINER_TAGS = Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_LIST_CONTAINER_TAGS"]);
function isEmphasis$1(el) {
    const style = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) && el.getAttribute("style");
    return /font-style\s*:\s*italic/.test(style || "");
}
...
function isGoogleDocs(el) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) && !!el.getAttribute("data-is-google-docs");
}
function isRootNode(el) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) && !!el.getAttribute("data-is-root-node");
}
function getListItemStyle$1(el) {
    const parentTag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el.parentNode);
    if (!(parentTag && !LIST_CONTAINER_TAGS.includes(parentTag))) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el.parentNode) === "ul" ? "bullet" : "number";
}
function getListItemLevel$1(el) {
    let level = 0;
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) === "li") {
        let parentNode = el.parentNode;
        for(; parentNode;){
            const parentTag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(parentNode);
...
const blocks = {
    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_BLOCK_TAGS"],
    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_HEADER_TAGS"]
};
function getBlockStyle(schema, el) {
    const childTag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el.firstChild), block = childTag && blocks[childTag];
    return block ? schema.styles.some((style)=>style.name === block.style) ? block.style : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BLOCK_DEFAULT_STYLE"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BLOCK_DEFAULT_STYLE"];
}
function createGDocsRules(schema) {
    return [
        ...
        {
            deserialize (el, next) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) === "li" && isGoogleDocs(el)) return {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BLOCK"],
        ...
        {
            deserialize (el) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) === "br" && isGoogleDocs(el) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) && el.classList.contains("apple-interchange-newline")) return {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_SPAN"],
                    text: ""
                };
...
function createHTMLRules(schema, options) {
    return [
        whitespaceTextNodeRule,
        {
            // Pre element
            deserialize (el) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) !== "pre") return;
        ...
        {
            deserialize (el, next) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) !== "blockquote") return;
                const blocks2 = {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_BLOCK_TAGS"],
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_HEADER_TAGS"]
                };
        ...
        // Block elements
        {
            deserialize (el, next) {
                const blocks2 = {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_BLOCK_TAGS"],
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_HEADER_TAGS"]
                }, tag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el);
                let block = tag ? blocks2[tag] : void 0;
                if (!block) return;
                if (el.parentNode && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el.parentNode) === "li") return next(el.childNodes);
                const blockStyle = block.style;
                return schema.styles.some((style)=>style.name === blockStyle) || (block = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BLOCK"]), {
                    ...block,
        ...
        {
            deserialize (el, next) {
                const tag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el);
                if (!(!tag || !(tag in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_SPAN_TAGS"]))) return next(el.childNodes);
            }
        },
        // Ignore div tags
        {
            deserialize (el, next) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) === "div") return next(el.childNodes);
            }
        },
        // Ignore list containers
        {
            deserialize (el, next) {
                const tag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el);
                if (!(!tag || !(tag in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_LIST_CONTAINER_TAGS"]))) return next(el.childNodes);
            }
        },
        // Deal with br's
        {
            deserialize (el) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) === "br") return {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_SPAN"],
                    text: `
`
                };
        ...
        // Deal with list items
        {
            deserialize (el, next, block) {
                const tag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el), listItem = tag ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_LIST_ITEM_TAGS"][tag] : void 0;
                if (!listItem) return;
                const parentTag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el.parentNode) || "", listTag = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_LIST_CONTAINER_TAGS"][parentTag] ? parentTag : "ul", enabledListItem = resolveListItem(schema, listTag);
        ...
        {
            deserialize (el, next) {
                const decorator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_DECORATOR_TAGS"][(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) || ""];
        ...
        {
            deserialize (el, next) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) !== "a") return;
                const linkEnabled = schema.annotations.some((annotation)=>annotation.name === "link"), href = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) && el.getAttribute("href");
        ...
        {
            deserialize (el, next) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) && ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) === "td" || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el) === "th")) return {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BLOCK"],
                    children: next(el.childNodes)
                };
            }
...
function isNotion(el) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el) && !!el.getAttribute("data-is-notion");
}
...
function isWordListElement(el) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isElement"])(el)) return !1;
...
function getHeadingStyle(el) {
    const tag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el);
    if (tag && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_HEADER_TAGS"][tag]) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_HEADER_TAGS"][tag]?.style;
}
    ...
    return [
        {
            deserialize (el, next) {
                const tag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(el);
                if ((tag === "p" || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HTML_HEADER_TAGS"][tag || ""]) && isWordListElement(el)) {
                    const headingStyle = getHeadingStyle(el);
                    return {
                        ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BLOCK"],
                        listItem: getListItemStyle(el),
                        level: getListItemLevel(el),
                        style: headingStyle || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BLOCK_DEFAULT_STYLE"],
                        children: next(el.childNodes)
                    };
                }
            }
...
function trimTextBlockWhitespace(block) {
    ...
    for (const child of block.children){
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMinimalSpan"])(child)) {
            index++;
            continue;
        }
        const nextChild = nextSpan(block, index), prevChild = prevSpan(block, index);
        index === 0 && (child.text = child.text.replace(/^[^\S\n]+/g, "")), index === block.children.length - 1 && (child.text = child.text.replace(/[^\S\n]+$/g, "")), /\s/.test(child.text.slice(Math.max(0, child.text.length - 1))) && nextChild && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMinimalSpan"])(nextChild) && /\s/.test(nextChild.text.slice(0, 1)) && (child.text = child.text.replace(/[^\S\n]+$/g, "")), /\s/.test(child.text.slice(0, 1)) && prevChild && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMinimalSpan"])(prevChild) && /\s/.test(prevChild.text.slice(Math.max(0, prevChild.text.length - 1))) && (child.text = child.text.replace(/^[^\S\n]+/g, "")), child.text || block.children.splice(index, 1), prevChild && Array.isArray(prevChild.marks) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isEqualMarks"])(prevChild.marks, child.marks) && isWhiteSpaceChar(child.text) ? (prevChild.text += " ", block.children.splice(index, 1)) : nextChild && Array.isArray(nextChild.marks) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isEqualMarks"])(nextChild.marks, child.marks) && isWhiteSpaceChar(child.text) && (nextChild.text = ` ${nextChild.text}`, block.children.splice(index, 1)), index++;
    }
    return block;
}
...
class HtmlDeserializer {
   ...
   */ constructor(schema, options = {}){
        ...
        const parseHtml = options.parseHtml || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultParseHtml"])();
        this.parseHtml = (html)=>{
            const cleanHTML = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$stega$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vercelStegaClean"])(html), doc = parseHtml(cleanHTML);
   ...
   */ deserialize = (html)=>{
        ...
        const { parseHtml } = this, fragment = parseHtml(html), children = Array.from(fragment.childNodes), blocks2 = trimWhitespace({
            schema: this.schema
        }, this.whitespaceMode, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["flattenNestedBlocks"])({
            schema: this.schema
        }, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureRootIsBlocks"])(this.schema, this.deserializeElements(children))));
   ...
   */ deserializeElement = (element)=>{
        const next = (elements)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isNodeList"])(elements)) return this.deserializeElements(Array.from(elements));
        ...
        for(let i = 0; i < this.rules.length; i++){
            ...
            const ret = rule.deserialize(element, next, block), type = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolveJsType"])(ret);
            ...
            if (ret !== void 0) {
                {
                    ...
                    Array.isArray(ret) ? node = ret : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isPlaceholderDecorator"])(ret) ? node = this.deserializeDecorator(ret) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isPlaceholderAnnotation"])(ret) ? node = this.deserializeAnnotation(ret) : node = ret;
                }
                if (ret && !Array.isArray(ret) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMinimalBlock"])(ret) && "listItem" in ret) {
                    let parent = element.parentNode?.parentNode;
                    for(; parent && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tagName"])(parent) === "li";)parent = parent.parentNode?.parentNode, ret.level = ret.level ? ret.level + 1 : 1;
                }
                ret && !Array.isArray(ret) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMinimalBlock"])(ret) && ret.style === "blockquote" && ret.children.forEach((child, index)=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMinimalSpan"])(child) && child.text === "\r" && (child.text = `
`, (index === 0 || index === ret.children.length - 1) && ret.children.splice(index, 1));
   ...
   */ deserializeDecorator = (decorator)=>{
        const { name } = decorator, applyDecorator = (node)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isPlaceholderDecorator"])(node)) return this.deserializeDecorator(node);
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMinimalSpan"])(node)) node.marks = node.marks || [], node.text.trim() && node.marks.unshift(name);
   ...
   */ deserializeAnnotation = (annotation)=>{
        ...
        const applyAnnotation = (node)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isPlaceholderAnnotation"])(node)) return this.deserializeAnnotation(node);
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMinimalSpan"])(node)) node.marks = node.marks || [], node.text.trim() && node.marks.unshift(markDef._key);
            else if ("children" in node && Array.isArray(node.children)) {
                const block = node;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@portabletext/html/dist/index.js [app-ssr] (ecmascript)");
...
function normalizeBlock(node, options = {}) {
    ...
    return block.children = block.children.reduce((acc, child)=>{
        ...
        return previousChild && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSpan"])({
            ...
            schema
        }, previousChild) && isEqualMarks(previousChild.marks, child.marks) ? (lastChild && lastChild === child && child.text === "" && block.children.length > 1 || (previousChild.text += child.text), acc) : (acc.push(child), acc);
    }, []).map((child)=>{
        if (!child) throw new Error("missing child");
        return child._key = options.keyGenerator ? options.keyGenerator() : keyGenerator(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSpan"])({
            schema
...
function htmlToBlocks(html, schemaType, options = {}) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$html$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["htmlToPortableText"])(html, {
        schema,
        keyGenerator: options.keyGenerator,
        parseHtml: options.parseHtml,
        rules: options.rules,
...
function adaptMatchers(matchers) {
    if (!(!matchers?.image && !matchers?.inlineImage)) return {
...
//# sourceMappingURL=node_modules_%40portabletext_18da30a6._.js.map