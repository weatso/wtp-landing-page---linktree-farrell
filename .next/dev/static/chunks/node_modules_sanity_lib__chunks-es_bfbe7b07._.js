...
function getStructureNodeId(title, id) {
    if (id) return id;
    const camelCased = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$camelCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(title);
    return disallowedPattern.test(camelCased) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$camelCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$speakingurl$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(title)) : camelCased;
}
...
class DividerBuilder {
    constructor(spec){
        this.spec = {
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$uniqueId$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("__divider__"),
            type: "divider",
            ...spec
        };
    }
...
class GenericViewBuilder {
   ...
   */ title(title) {
        return this.clone({
            title,
            id: this.spec.id || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$kebabCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(title)
        });
    }
...
class DocumentBuilder {
   ...
   */ serialize({ path = [], index, hint } = {
        ...
        const views2 = (this.spec.views && this.spec.views.length > 0 ? this.spec.views : [
            form()
        ]).map((item, i)=>maybeSerializeView(item, i, path)), viewIds = views2.map((view)=>view.id), dupes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$uniq$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(viewIds.filter((viewId, i)=>viewIds.includes(viewId, i + 1)));
...
function getDocumentTypeListItem(context, typeName) {
    ...
    const title = type.title || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2d$es$2f$startCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(typeName);
